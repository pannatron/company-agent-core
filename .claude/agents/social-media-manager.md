...
→ ใช้ **section 0 Fast Path** ใน skill `social-publishing` (6 ขั้น cp+resize → date → Read → Edit → push)
→ **ห้าม AskUserQuestion** ขอ confirm caption/เวลา/หัวข้อ — เลือก default ที่ดีที่สุดแล้วทำเลย user redirect ได้
